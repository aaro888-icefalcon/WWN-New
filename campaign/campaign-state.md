...
- **Chaos Factor:** 7  *(floor 6; +1 scene 14 — a Turning Point cracked the realm (Almeric hunted, Old Vael lit) & the Factors shipped the taken downriver; Shake watched Alys carried off, unable to act — the world ran him)*
...
- **★ SAVE POINT (resume here):** **Scene 14 — the realm cracks; the river takes Alys.** At dawn, heading to swear Osric's ruin to honest **Warden Wynne**, a **Turning Point** broke in: word came up the river that **Lord Protector Almeric is *hunted*** — the capital in uproar, his grip cut from under him — and the long-dead **Reconquest of Old Vael** is suddenly **lit,** the western marches aflame. The wolves all lunge: **Marie's Claim pounces,** and her **Factors (Under-Factor Reynaud)** are evacuating wealth and **rift-folk 'stock' out of Mauressac by river** before the city understands. Shake reached Wynne **in the street** (not abed): she took the Osric case at a glance (**bring the bones at noon, swear before two witnesses → Osric in irons by dusk**) and pointedly did **not** pry into him (F2 Exc-Yes — far bigger fish this morning). Then Shake **shadowed the convoy** (Int success) to the long quay and found the shape of the second book's answer: **the taken go by water — downriver, toward the lowlands/sea-reach** — and saw **Alys aboard a barge (a green-eye sigil on its stern), alive, bound, shorn.** He moved to set a diversion fire to free her — **failed the unseen check** — and, true to his own rule, would not be seen for a bad chance. **The barge cast off. Alys is gone downriver; the river is now a *lead,* not a rescue.** HP 6/6 · Effort 3/3 · purse ~56 sp · Chaos 7. **Next beat:** *the dawn→noon GAP — survive Gault (Osric's enforcer, hunting loose ends), regroup with Aldhelm & the bones, and reach Wynne's house at noon to swear the case and set Osric's ruin.*
...
9. Bring down Warden Osric — Hroth's murderer (with Wynne, vs Gault)
10. The Reconquest of Old Vael — the marches lit (no longer stalled)  _(weight 2)_
11. The river road — where the taken go (downriver by barge; Alys & Akhil's people aboard)  _(weight 2)_
...
12. Tanya (Bronx FDNY medic — leader of the Factors' rift-folk stock)
13. Alys (the Factors' coerced ledger-girl; Garin's ward)
14. Under-Factor Reynaud (holds Alys & the second book)  _(weight 2)_
15. Warden Osric (Low Quarter — risen, buries his past)  _(weight 2)_
16. Aldhelm (Keeper of the veterans' brotherhood; Shake's ally)
17. Warden Wynne (honest river-warden; the lawful hand)
