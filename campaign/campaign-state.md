...
- **Chaos Factor:** 7  *(floor 6; HELD scene 15 — a chaotic gauntlet (Gault's ambush → flight → door-trap) balanced by Shake wrestling the climax back with wits; the world stays turbulent at 7)*
...
- **★ SAVE POINT (resume here):** **Scene 15 — the gauntlet to noon (Gault's hunt).** Making for Warden Wynne's with the bones, **two Turning Points** hit: realm-horror news deepened (a raving **sole survivor** of the **Worm waking in the west**; **Count Gruith's** banner down) and **Gault** (Osric's enforcer) ambushed the party in a public square — **6 hostiles, Gault leading in person** (Exc-Yes). Shake called the run; opposed flight **won on a tie** → escaped into the crowd but took a **shoulder clip (HP 6→4)**. He chose Wynne's **door** — but Gault **beat him there** (Exc-Yes) and Wynne was **out** (3 streets east at the river-men); the household wouldn't open (Fate No). Cornered at the green door, Shake **negotiated with the truth**: threatened to pitch the skull into Wynne's cabbages and **shout Osric's murder to a lane full of waking witnesses** unless Gault stood down. Opposed **PC 12 vs 9 — Gault backed off** (killing them now *broadcasts* the secret). **Gault withdrew with a promise** (*he'll know Shake's face; "Osric won't share his lifeboat"*). **Osric is now WARNED; Shake is MARKED by Gault;** the accusation is loose as **street rumor.** HP **4/6** · Effort 3/3 · purse ~56 sp · Chaos 7. **Next beat:** *reach Warden Wynne (3 streets east, or hold for noon) and swear the case — FAST, before Osric flees / his patrons move; tend the shoulder.*
